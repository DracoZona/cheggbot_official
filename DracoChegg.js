...
global.username = 'jaspervan.marcellones@gmail.com'
global.password = 'S3bastian'
global.discordlogin = 'NzU1ODMxODI4NDg4NjUwOTU1.X2JBPg.K1HLlDWez-HYd9LY7hlkvn6dpSQ'
    ...
    if (message.content.startsWith(`?chegg`)) {
        ...
        if (!s.includes('https://www.chegg.com/homework-help')) {
            const errorEmbed = new Discord.MessageEmbed()
                ...
                .setDescription('No no no! Chegg links only please. Wag matigas ang ulo.')
                .setThumbnail('https://images-ext-1.discordapp.net/external/9yiAQ7ZAI3Rw8ai2p1uGMsaBIQ1roOA4K-ZrGbd0P_8/https/cdn1.iconfinder.com/data/icons/web-essentials-circle-style/48/delete-512.png?width=461&height=461')
                .setTimestamp()
               .setFooter('Bot created by DracoZona.');
        ...
        async function process_answer(url) {
            ...
            const processEmbed = new Discord.MessageEmbed()
                .setColor('#F85B00')
                .setTitle('Please wait while I process your requested URL.')
                .setURL('https://twitter.com/#')
                .setDescription('Your chegg link is currently being retrieved by the AI.')
                .setTimestamp()
                .setFooter('Bot created by DracoZona.');
            ...
            const successEmbed = new Discord.MessageEmbed()
                ...
                .setTitle('Success')
                .setURL('https://twitter.com/#')
                .setDescription('Your answer has been generated, check your DMs!')
